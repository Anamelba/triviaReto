...
function accept()
{
  ...
  document.getElementById("question1").innerHTML = "SELECCIONA LA RESPUESTA: ";
  ...
  var t = document.createTextNode("aaaaaaaaaaaa");
  ya.appendChild(t);
  ...
  var t = document.createTextNode("bbbbbbbbbbbbb");
  yb.appendChild(t);
  ...
  var t = document.createTextNode("ccccccccccc");
  yc.appendChild(t);
...
function question2()
{
  ...
  var pQuestion1 = document.createElement("P");
  var textQuestion1 = document.createTextNode("2. ¿pregunta2?");
  pQuestion1.appendChild(textQuestion1);
...
function question3()
{
  ...
  var pQuestion1 = document.createElement("P");
  var textQuestion1 = document.createTextNode("3.¿pregunta3?");
  pQuestion1.appendChild(textQuestion1);
